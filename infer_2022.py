...
parser.add_argument("--save_dir", type=Path, default="./tmp/data2022")
...
parser.add_argument("--query", type=str, default="crime,spy,martial,sword,action,revenge,exquisite,highlight,humorous,dance,singing,war,military,gun,romance,horror,disaster")
...
def main():
    ...
    for row in df.itertuples():
        ...
        out_csv = save_dir / "saliency_v2.csv"
        if out_csv.exists():
            print(out_csv, 'exists')
            continue
        print(out_csv)
        extract_txt(args.query, save_dir)
